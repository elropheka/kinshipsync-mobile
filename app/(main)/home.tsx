...
const DashboardScreen: React.FC = () => {
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top','left', 'right', 'bottom']}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerIcons}>
          <TouchableOpacity onPress={() => setIsSearchVisible(!isSearchVisible)} style={styles.headerIcon}>
            <Icon name="search" size={25} color={Colors.light.tint} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => router.push('/notifications')} style={styles.headerIcon}>
            <SecondaryIcon name="notifications-outline" size={25} color={Colors.light.tint} />
          </TouchableOpacity>
          <TouchableOpacity onPress={globalToggleSidebar} style={[styles.headerIcon, { paddingLeft: 4, paddingTop: 1 }]}>
            <SecondaryIcon name="menu-outline" size={25} color={Colors.light.tint} />
          </TouchableOpacity>
        </View>
      </View>
      ...
      {/* My Dashboard Title */}
      <Text style={styles.dashboardTitle}>Welcome, {welcomeName}!</Text>
      <ScrollView style={styles.dashboardContent} showsVerticalScrollIndicator={false} onScroll={handleScroll} scrollEventThrottle={16}>
      ...
      <View style={styles.adPlaceholderBanner}>
